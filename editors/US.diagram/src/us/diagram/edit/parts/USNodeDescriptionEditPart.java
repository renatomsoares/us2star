 ...
 * @generated
 */
public class USNodeDescriptionEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public USNodeDescriptionEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UsParserProvider
					.getParser(
							UsElementTypes.USNode_2001,
							getParserElement(),
							UsVisualIDRegistry
									.getType(us.diagram.edit.parts.USNodeDescriptionEditPart.VISUAL_ID));
		}
		return parser;
	}
