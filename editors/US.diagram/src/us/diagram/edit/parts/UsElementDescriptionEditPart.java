...
import us.diagram.edit.policies.UsTextSelectionEditPolicy;
 ...
 * @generated
 */
public class UsElementDescriptionEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public UsElementDescriptionEditPart(View view) {
		super(view);
	}
	...
	protected Image getLabelIcon() {
		...
		return UsElementTypes.getImage(parserElement.eClass());
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UsParserProvider
					.getParser(
							UsElementTypes.UsElement_3001,
							getParserElement(),
							UsVisualIDRegistry
									.getType(us.diagram.edit.parts.UsElementDescriptionEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, null,
					UsEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
