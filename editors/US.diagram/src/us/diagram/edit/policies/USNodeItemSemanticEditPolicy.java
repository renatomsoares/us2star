 ...
 * @generated
 */
public class USNodeItemSemanticEditPolicy extends UsBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public USNodeItemSemanticEditPolicy() {
	...
	private void addDestroyChildNodesCommand(ICompositeCommand cmd) {
		...
		for (Iterator<?> nit = view.getChildren().iterator(); nit.hasNext();) {
			...
			switch (UsVisualIDRegistry.getVisualID(node)) {
			case USNodeUSNodeElementsCompartmentEditPart.VISUAL_ID:
				for (Iterator<?> cit = node.getChildren().iterator(); cit
						.hasNext();) {
					Node cnode = (Node) cit.next();
					switch (UsVisualIDRegistry.getVisualID(cnode)) {
