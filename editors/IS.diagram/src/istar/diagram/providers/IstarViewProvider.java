...
public class IstarViewProvider extends AbstractProvider implements
	...
	protected boolean provides(CreateDiagramViewOperation op) {
		return IstarModelEditPart.MODEL_ID.equals(op.getSemanticHint())
	...
	protected boolean provides(CreateNodeViewOperation op) {
		...
		if (op.getSemanticHint() == null) {
			...
			if (elementType != null) {
				...
				if (!IstarModelEditPart.MODEL_ID.equals(IstarVisualIDRegistry
		...
		return IstarElementEditPart.VISUAL_ID == visualID
				|| IstarCompartmentEditPart.VISUAL_ID == visualID
				|| IstarElement2EditPart.VISUAL_ID == visualID;
	}
	...
	public Diagram createDiagram(IAdaptable semanticAdapter,
		...
		diagram.setType(IstarModelEditPart.MODEL_ID);
	...
	public Node createNode(IAdaptable semanticAdapter, View containerView,
		...
		switch (visualID) {
		case IstarElementEditPart.VISUAL_ID:
			return createIstarElement_2001(domainElement, containerView, index,
					persisted, preferencesHint);
		case IstarCompartmentEditPart.VISUAL_ID:
			return createIstarCompartment_2002(domainElement, containerView,
					index, persisted, preferencesHint);
		case IstarElement2EditPart.VISUAL_ID:
			return createIstarElement_3001(domainElement, containerView, index,
					persisted, preferencesHint);
		}
	...
	public Edge createEdge(IAdaptable semanticAdapter, View containerView,
		...
		case IstarActorLinkEditPart.VISUAL_ID:
			return createIstarActorLink_4001(
					getSemanticElement(semanticAdapter), containerView, index,
					persisted, preferencesHint);
		case IstarDependencyLinkEditPart.VISUAL_ID:
			return createIstarDependencyLink_4002(
					getSemanticElement(semanticAdapter), containerView, index,
					persisted, preferencesHint);
		case IstarMeanEndLinkEditPart.VISUAL_ID:
			return createIstarMeanEndLink_4003(
					getSemanticElement(semanticAdapter), containerView, index,
					persisted, preferencesHint);
		case IstarTaskDecompositionEditPart.VISUAL_ID:
			return createIstarTaskDecomposition_4004(
					getSemanticElement(semanticAdapter), containerView, index,
					persisted, preferencesHint);
		case IstarContributionLinkEditPart.VISUAL_ID:
			return createIstarContributionLink_4005(
					getSemanticElement(semanticAdapter), containerView, index,
					persisted, preferencesHint);
		}
	 ...
	 * @generated
	 */
	public Node createIstarElement_2001(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(IstarVisualIDRegistry
	 ...
	 * @generated
	 */
	public Node createIstarCompartment_2002(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.getStyles().add(
	 ...
	 * @generated
	 */
	public Node createIstarElement_3001(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
	 ...
	 * @generated
	 */
	public Edge createIstarActorLink_4001(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
	 ...
	 * @generated
	 */
	public Edge createIstarDependencyLink_4002(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Connector edge = NotationFactory.eINSTANCE.createConnector();
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
	 ...
	 * @generated
	 */
	public Edge createIstarMeanEndLink_4003(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Connector edge = NotationFactory.eINSTANCE.createConnector();
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
	 ...
	 * @generated
	 */
	public Edge createIstarTaskDecomposition_4004(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Connector edge = NotationFactory.eINSTANCE.createConnector();
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
	 ...
	 * @generated
	 */
	public Edge createIstarContributionLink_4005(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Connector edge = NotationFactory.eINSTANCE.createConnector();
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
	...
	private void stampShortcut(View containerView, Node target) {
		if (!IstarModelEditPart.MODEL_ID.equals(IstarVisualIDRegistry
			...
			shortcutAnnotation.getDetails().put(
					"modelID", IstarModelEditPart.MODEL_ID); //$NON-NLS-1$
