 ...
 * @generated
 */
public class IstarElementName2EditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public IstarElementName2EditPart(View view) {
		super(view);
	}
			...
			parser = IstarParserProvider
					.getParser(
							...
							IstarVisualIDRegistry
									.getType(istar.diagram.edit.parts.IstarElementName2EditPart.VISUAL_ID));
		}
		return parser;
	}
