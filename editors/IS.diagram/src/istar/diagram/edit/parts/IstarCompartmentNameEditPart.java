 ...
 * @generated
 */
public class IstarCompartmentNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public IstarCompartmentNameEditPart(View view) {
		super(view);
	}
			...
			parser = IstarParserProvider
					.getParser(
							...
							IstarVisualIDRegistry
									.getType(istar.diagram.edit.parts.IstarCompartmentNameEditPart.VISUAL_ID));
		}
		return parser;
	}
