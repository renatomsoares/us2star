 ...
 * @generated
 */
public class IstarActorLinkTypeEditPart extends LabelEditPart implements
		ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				IstarVisualIDRegistry
						.getType(istar.diagram.edit.parts.IstarActorLinkTypeEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	 ...
	 * @generated
	 */
	public IstarActorLinkTypeEditPart(View view) {
		super(view);
	}
	...
	protected IFigure createFigurePrim() {
		return new IstarActorLinkLabelFigure();
	}

	/**
	 * @generated
	 */
	public class IstarActorLinkLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public IstarActorLinkLabelFigure() {
			this.setText("IstarActorLink");
		}
