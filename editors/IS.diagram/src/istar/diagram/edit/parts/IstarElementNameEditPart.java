 ...
 * @generated
 */
public class IstarElementNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public IstarElementNameEditPart(View view) {
		super(view);
	}
			...
			parser = IstarParserProvider
					.getParser(
							...
							IstarVisualIDRegistry
									.getType(istar.diagram.edit.parts.IstarElementNameEditPart.VISUAL_ID));
		}
		return parser;
	}
