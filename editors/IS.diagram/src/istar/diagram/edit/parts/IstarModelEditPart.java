...
import istar.diagram.edit.policies.IstarModelCanonicalEditPolicy;
import istar.diagram.edit.policies.IstarModelItemSemanticEditPolicy;
 ...
 * @generated
 */
public class IstarModelEditPart extends DiagramEditPart {
	 ...
	 * @generated
	 */
	public IstarModelEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new IstarModelItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new IstarModelCanonicalEditPolicy());
