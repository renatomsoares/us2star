...
import istar.diagram.edit.commands.IstarActorLinkCreateCommand;
import istar.diagram.edit.commands.IstarActorLinkReorientCommand;
 ...
 * @generated
 */
public class IstarCompartmentItemSemanticEditPolicy extends
		IstarBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public IstarCompartmentItemSemanticEditPolicy() {
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getTargetEdges().iterator(); it.hasNext();) {
			...
			if (IstarVisualIDRegistry.getVisualID(incomingLink) == IstarActorLinkEditPart.VISUAL_ID) {
		...
		for (Iterator<?> it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (IstarVisualIDRegistry.getVisualID(outgoingLink) == IstarActorLinkEditPart.VISUAL_ID) {
				DestroyElementRequest r = new DestroyElementRequest(
	...
	protected Command getStartCreateRelationshipCommand(
		...
		if (IstarElementTypes.IstarActorLink_4001 == req.getElementType()) {
			return getGEFWrapper(new IstarActorLinkCreateCommand(req,
	...
	protected Command getReorientRelationshipCommand(
		...
		case IstarActorLinkEditPart.VISUAL_ID:
			return getGEFWrapper(new IstarActorLinkReorientCommand(req));
