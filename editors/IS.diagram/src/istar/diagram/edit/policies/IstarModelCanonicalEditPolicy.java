 ...
 * @generated
 */
public class IstarModelCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected Set getFeaturesToSynchronize() {
		if (myFeaturesToSynchronize == null) {
			...
			myFeaturesToSynchronize.add(IstarPackage.eINSTANCE
					.getIstarModel_Elements());
			myFeaturesToSynchronize.add(IstarPackage.eINSTANCE
					.getIstarModel_Compartments());
		}
	...
	protected List getSemanticChildrenList() {
		...
		List<IstarNodeDescriptor> childDescriptors = IstarDiagramUpdater
				.getIstarModel_1000SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		...
		return visualID == IstarElementEditPart.VISUAL_ID
				|| visualID == IstarCompartmentEditPart.VISUAL_ID;
	}
	...
	protected void refreshSemantic() {
		...
		List<IstarNodeDescriptor> childDescriptors = IstarDiagramUpdater
				.getIstarModel_1000SemanticChildren((View) getHost().getModel());
	...
	private Collection<IstarLinkDescriptor> collectAllLinks(View view,
		...
		case IstarModelEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(IstarDiagramUpdater
						.getIstarModel_1000ContainedLinks(view));
			}
		...
		case IstarElementEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(IstarDiagramUpdater
						.getIstarElement_2001ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case IstarCompartmentEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(IstarDiagramUpdater
						.getIstarCompartment_2002ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case IstarElement2EditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(IstarDiagramUpdater
						.getIstarElement_3001ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case IstarActorLinkEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(IstarDiagramUpdater
						.getIstarActorLink_4001ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case IstarDependencyLinkEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(IstarDiagramUpdater
						.getIstarDependencyLink_4002ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case IstarMeanEndLinkEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(IstarDiagramUpdater
						.getIstarMeanEndLink_4003ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case IstarTaskDecompositionEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(IstarDiagramUpdater
						.getIstarTaskDecomposition_4004ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case IstarContributionLinkEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(IstarDiagramUpdater
						.getIstarContributionLink_4005ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
