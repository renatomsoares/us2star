 ...
 * @generated
 */
public class IstarCompartmentIstarCompartmentElementsCompartmentCanonicalEditPolicy
	...
	protected EStructuralFeature getFeatureToSynchronize() {
		return IstarPackage.eINSTANCE.getIstarCompartment_Elements();
	}
	...
	protected List getSemanticChildrenList() {
		...
		List<IstarNodeDescriptor> childDescriptors = IstarDiagramUpdater
				.getIstarCompartmentIstarCompartmentElementsCompartment_7001SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		return IstarElement2EditPart.VISUAL_ID == IstarVisualIDRegistry
				.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<IstarNodeDescriptor> childDescriptors = IstarDiagramUpdater
				.getIstarCompartmentIstarCompartmentElementsCompartment_7001SemanticChildren((View) getHost()
						.getModel());
