 ...
 * @generated
 */
public class IstarMeanEndLinkReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public IstarMeanEndLinkReorientCommand(ReorientRelationshipRequest request) {
	...
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof IstarMeanEndLink) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		...
		return IstarBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistIstarMeanEndLink_4003(container, getLink(),
						getNewSource(), target);
	}
	...
	protected boolean canReorientTarget() {
		...
		IstarCompartment container = (IstarCompartment) getLink().eContainer();
		return IstarBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistIstarMeanEndLink_4003(container, getLink(), source,
						getNewTarget());
	}
	 ...
	 * @generated
	 */
	protected IstarMeanEndLink getLink() {
		return (IstarMeanEndLink) getElementToEdit();
	}
