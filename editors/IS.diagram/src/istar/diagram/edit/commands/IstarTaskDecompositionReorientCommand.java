 ...
 * @generated
 */
public class IstarTaskDecompositionReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public IstarTaskDecompositionReorientCommand(
	...
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof IstarTaskDecomposition) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		...
		return IstarBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistIstarTaskDecomposition_4004(container, getLink(),
						getNewSource(), target);
	}
	 ...
	 * @generated
	 */
	protected IstarTaskDecomposition getLink() {
		return (IstarTaskDecomposition) getElementToEdit();
	}
